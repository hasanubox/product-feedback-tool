<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('feedbacks.create')">
                                {{ __('Create') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('feedbacks.index')">
                                {{ __('List') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('feedbacks.vote')">
                                {{ __('Vote') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">Feedback</div>
            </div>

            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('feedbacks.create')">
                    {{ __('Create') }}
                </x-responsive-nav-link>
                ...
                <x-responsive-nav-link :href="route('feedbacks.vote')">
                    {{ __('Vote') }}
                </x-responsive-nav-link>
            </div>
            <br />
